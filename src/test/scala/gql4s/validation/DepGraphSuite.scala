...
class DepGraphSuite extends FunSuite:
  ...
  val hasCycles1 = List(
    FragmentDefinition(Name("A"), NamedType(Name("T")), Nil, NonEmptyList.of(FragmentSpread(Name("B"), Nil))),
    FragmentDefinition(Name("B"), NamedType(Name("T")), Nil, NonEmptyList.of(FragmentSpread(Name("A"), Nil)))
  )

  val hasCycles2 = List(
    FragmentDefinition(Name("E"), NamedType(Name("T")), Nil, NonEmptyList.of(FragmentSpread(Name("D"), Nil))),
    FragmentDefinition(Name("D"), NamedType(Name("T")), Nil, NonEmptyList.of(FragmentSpread(Name("B"), Nil))),
    FragmentDefinition(Name("C"), NamedType(Name("T")), Nil, NonEmptyList.of(FragmentSpread(Name("A"), Nil))),
    FragmentDefinition(Name("B"), NamedType(Name("T")), Nil, NonEmptyList.of(FragmentSpread(Name("C"), Nil))),
    FragmentDefinition(Name("A"), NamedType(Name("T")), Nil, NonEmptyList.of(FragmentSpread(Name("D"), Nil)))
  )
  ...
  val noCycles1 = List(
    ...
    FragmentDefinition(Name("C"), NamedType(Name("T")), Nil, NonEmptyList.of(FragmentSpread(Name("A"), Nil))),
    FragmentDefinition(Name("B"), NamedType(Name("T")), Nil, NonEmptyList.of(FragmentSpread(Name("C"), Nil))),
    FragmentDefinition(Name("A"), NamedType(Name("T")), Nil, NonEmptyList.of(Field(None, Name("a"), Nil, Nil, Nil)))
  )
  ...
  val noCycles2 = List(
    ...
    FragmentDefinition(Name("C"), NamedType(Name("T")), Nil, NonEmptyList.of(FragmentSpread(Name("A"), Nil))),
    FragmentDefinition(Name("B"), NamedType(Name("T")), Nil, NonEmptyList.of(FragmentSpread(Name("C"), Nil))),
    FragmentDefinition(Name("B"), NamedType(Name("T")), Nil, NonEmptyList.of(FragmentSpread(Name("E"), Nil))),
    FragmentDefinition(Name("E"), NamedType(Name("T")), Nil, NonEmptyList.of(FragmentSpread(Name("A"), Nil))),
    FragmentDefinition(Name("A"), NamedType(Name("T")), Nil, NonEmptyList.of(Field(None, Name("a"), Nil, Nil, Nil)))
  )
